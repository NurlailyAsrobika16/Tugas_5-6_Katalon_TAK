...
def response = WS.sendRequest(findTestObject('CoverPhotos/GET'))
...
// Verifikasi field pertama tidak null
assertThat(jsonResponse[0].id).isNotNull()
assertThat(jsonResponse[0].idBook).isNotNull()
assertThat(jsonResponse[0].url).isNotNull()

// Verifikasi tipe data
assertThat(jsonResponse[0].id).isInstanceOf(Integer)
assertThat(jsonResponse[0].idBook).isInstanceOf(Integer)
assertThat(jsonResponse[0].url).isInstanceOf(String)

// Verifikasi field tidak kosong
assertThat(jsonResponse[0].url.toString()).isNotEmpty()
