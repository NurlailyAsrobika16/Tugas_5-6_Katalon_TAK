...
def response = WS.sendRequest(findTestObject('Books/POST'))
...
// Verifikasi nilai yang dikirim
assertThat(jsonResponse.title).isEqualTo("The Great Journey")
assertThat(jsonResponse.description).isEqualTo("A compelling story about life and adventure")
assertThat(jsonResponse.pageCount).isEqualTo(320)
assertThat(jsonResponse.excerpt).isEqualTo("It was a dark and stormy night when everything changed...")
