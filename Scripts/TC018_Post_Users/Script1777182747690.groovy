...
def response = WS.sendRequest(findTestObject('Users/POST'))
...
assertThat(jsonResponse.userName).isEqualTo("UserBaru")
assertThat(jsonResponse.password).isEqualTo("PassBaru123")
