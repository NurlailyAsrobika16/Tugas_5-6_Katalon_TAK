...
def response = WS.sendRequest(findTestObject('Authors/POST'))
...
assertThat(jsonResponse.firstName).isEqualTo("Nurlaily")
assertThat(jsonResponse.lastName).isEqualTo("Asrobika")
